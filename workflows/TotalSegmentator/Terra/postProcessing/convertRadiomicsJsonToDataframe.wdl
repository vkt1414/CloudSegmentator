...
workflow radiomicsJsonConversion {
 input {
   ...
   String docker_radiomicsJsonToDataFrame = "vkt1414/convert_radiomics_features_json_to_dataframe:main"
...
task radiomicsJsonToDataFrame{
 ...
 command {
   wget https://raw.githubusercontent.com/vkt1414/CloudSegmentator/zones_radiomicsJsonToDataFrame/workflows/TotalSegmentator/Notebooks/postProcessingRadiomicsJsonToDataFrame.ipynb
